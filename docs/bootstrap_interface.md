...
Kinetic 1.2.0's pointer/count array aggregate is internal to generated programs;
...
compiler release number. Length queries and range checks alone do not implement
the checked allocation and lifetime requirements below.
